const projects = [
    {
        ...
        process: [{
            ...
            image: '', 
            planningAndDesign: [{
                text: 'This assignment was also my exam, and I started the job by creating a Gantt Chart where I planned the time I had available. This included research, sketching, HTML/CSS, user testing, validating, and release. <br><br> My first design was mostly blue and white, as I wanted it to reflect Infotech\'s old website. However, I discovered that this color scheme didn\'t work out the way i envisioned. Because of this, I started to experiment with different colors, and ended up using an orange / gray / white color scheme. <br><br> By changing the color scheme, the overall feeling of the site became a lot happier as it was lighter with more vigorous colors. The orange color is also more suitable for the target audience, construction business. <br><br> I decided to make all the icons from scratch, and throughout the process, they transformed into simpler, and flat icons. An example of this is the money icon.',
                image: '',
            }],
            developing: [{
