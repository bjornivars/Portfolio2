                ...
                <div className=' [ specific ] '>
                    <div className=' [ specific-box col-12 ] '>
                        ...
                        <div className=' [ col-12 m-auto ] '>
                            ...
                            <img className=' [ col-8 col-tablet-12 m-auto col-mobile-11 ] ' src={colorImage} alt='Color Pallette' />
                            <p dangerouslySetInnerHTML={{ __html: colorText }} className=' [ project-container-p col-8 col-tablet-12 col-mobile-12  ] ' />

                            <h4 className=' [ specific-box-subheader ] '>Icons / illustrations</h4>
                            <img className=' [ col-8 col-tablet-12 m-auto col-mobile-11 ] ' src={iconImage} alt='Icons' />
                            <p dangerouslySetInnerHTML={{ __html: iconText }} className=' [ project-container-p col-8 col-tablet-12 col-mobile-12 ] ' />

                            <div className=' [ col-2 m-auto ] '>
                        <img className=' [ col-12 divider ] ' src={require('./../assets/Icons/workSplitter.png')} alt='divider' />
                    </div>
                            <h4 className=' [ specific-box-subheader ] '>Prototype and Layout</h4>
                            <img className=' [ col-8 col-tablet-12 m-auto col-mobile-11 ] ' src={prototypeImage} alt='Prototype and Layout' />
                            <p dangerouslySetInnerHTML={{ __html: prototypeText }} className=' [ project-container-p col-8 col-tablet-12 col-mobile-12  ] ' />
                        ...
                        <img className=' [ col-12 divider ] ' src={require('./../assets/Icons/workSplitter.png')} alt='divider' />
                            ...
                            <img className=' [ col-8 col-tablet-12 m-auto col-mobile-11 ] ' src={developImage} alt='Icons' />
                            <p dangerouslySetInnerHTML={{ __html: developText }} className=' [ project-container-p col-8 col-tablet-12 col-mobile-12  ] ' />
                        ...
                        <img className=' [ col-12 divider ] ' src={require('./../assets/Icons/workSplitter.png')} alt='divider' />
                            ...
                            <a href={websiteUrl} target='_blank' rel="noopener noreferrer">
                                <img className=' [ col-8 col-tablet-12 m-auto col-mobile-11 ] ' src={imageUrl} alt='Icons' />
                            </a>
