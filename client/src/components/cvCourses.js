                ...
                <Fade bottom>
                    <div className=' [ cv-container col-10 col-tablet-12 col-mobile-11 ] '>
                        <div className=' [ cv-container-company col-5 col-tablet-12 col-mobile-12 ] '>
                            <h4 className=' [ col-12 col-tablet-12 col-mobile-12 wordWrap ] '>NOKAS</h4>
                            <h5>2016</h5>
                        </div>
                        <div className=' [ cv-container-proffession col-6 col-tablet-12 col-mobile-12 ] '>
                            ...
                            <h5 className=' [ col-12 col-tablet-12 col-mobile-12 ] '><a className=' [ purple ] ' href={guardPdf} target="_blank" rel="noopener noreferrer">PDF</a> </h5>
                        </div>
                    </div>
                </Fade>
                <Fade bottom>
                    <div className='[ cv-container col-10 col-tablet-12 col-mobile-11 ]'>
                        ...
                        <div className=' [ cv-container-proffession col-6 col-tablet-12 col-mobile-12 ] '>
                            ...
                            <h5 className='[ col-12 col-tablet-12 col-mobile-12 ] '><a className=' [ purple ] ' href={firstAidPdf} target="_blank" rel="noopener noreferrer">PDF</a> </h5>
                        </div>
                    </div>
                </Fade>
            </div>
